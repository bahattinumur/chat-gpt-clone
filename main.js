...
let userText = null;
// API KEY'inizi bir alt satıra girin. --- Enter your API KEY in the next line.
const API_KEY = "";          
...
const getChatResponse = async (incomingChatDiv) => {
  ...
  try {
    ...
    console.log(error);
    pElement.textContent = "Try Again Please!";
...
const handleOutGoingChat = () => {
  userText = chatInput.value.trim(); // Chat-Input değerini alır ve fazladan boşlukları siler.
  if (!userText) return; // Chat-Inputun içi boş işe çalışmasın.
